        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-400 leading-relaxed max-w-md">
              ...
              Experiência em tecnologias front-end e back-end para projetos de alta qualidade.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a
                href={`https://wa.me/5567992124818?text=Olá, gostaria de entrar em contato!`}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center text-slate-400 hover:text-white transition-colors duration-200"
        ...
        <div className="border-t border-slate-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-slate-400 text-sm">
              © {currentYear} {username}. Todos os direitos reservados.
            </p>
